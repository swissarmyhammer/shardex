...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("------------------------");
    let default_config = ShardexConfig::new()
    ...
    println!("Generated {} test documents with {}-dimensional vectors", 
        test_data.len(), 768);
    ...
    println!("  - Avg shard utilization: {:.1}%", stats.average_shard_utilization * 100.0);
    ...
    println!("  - Configuration preserved: vector_size = {}", reopened_stats.vector_dimension);
